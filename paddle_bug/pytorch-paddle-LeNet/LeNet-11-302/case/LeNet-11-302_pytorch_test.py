...
class Model_osqq0k7w4fAyEx16LNpHxpVnki9ivsx4(nn.Module):
    def __init__(self):
        super(Model_osqq0k7w4fAyEx16LNpHxpVnki9ivsx4, self).__init__()
...
def go():
    try:
        model = Model_osqq0k7w4fAyEx16LNpHxpVnki9ivsx4().to('cuda')
