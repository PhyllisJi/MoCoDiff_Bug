...
output_dir = "./pytorch-paddle-LeNet/LeNet-11-302/case/pytorch_gpu/layer_outputs/"
...
class Model_7iqqNJoc8LgdfHpFybB049DQYfURiOHg(nn.Module):
    ...
    def forward(self, input):
        ...
        np.savez("./pytorch-paddle-LeNet/LeNet-11-302/case/pytorch_gpu/layer_outputs/fc2_output.npz",fc2_output.cpu().detach().numpy())
        relu4_output = self.relu4_mutated(fc2_output)
        np.savez("./pytorch-paddle-LeNet/LeNet-11-302/case/pytorch_gpu/layer_outputs/relu4_output.npz",relu4_output.cpu().detach().numpy())
...
print(output)
np.savez("./pytorch-paddle-LeNet/LeNet-11-302/case/pytorch_gpu/layer_outputs/output.npz",output)
np.savez("./pytorch-paddle-LeNet/LeNet-11-302/case/pytorch_gpu/grad-new.npz", **gradients)