...
class Model_sHWRrFYA2AE6nKm6AaTJRMTv2UG5uzwv(nn.Module):
    def __init__(self):
        super(Model_sHWRrFYA2AE6nKm6AaTJRMTv2UG5uzwv, self).__init__()
...
def go():
    try:
        model = Model_sHWRrFYA2AE6nKm6AaTJRMTv2UG5uzwv().to('cuda')
