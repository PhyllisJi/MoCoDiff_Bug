...
class Model_2BnjytwTP1ERvLgMOK6neoCeyRlLPn8g(nn.Module):
    def __init__(self):
        super(Model_2BnjytwTP1ERvLgMOK6neoCeyRlLPn8g, self).__init__()
...
def go():
    try:
        model = Model_2BnjytwTP1ERvLgMOK6neoCeyRlLPn8g().to('cuda')
