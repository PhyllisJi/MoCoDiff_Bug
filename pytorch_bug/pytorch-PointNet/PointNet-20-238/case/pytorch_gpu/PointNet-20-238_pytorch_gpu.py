...
class Model_pff92By4BWKfkMMOWt9O9J1YiviO0tKE(nn.Module):
    def __init__(self):
        super(Model_pff92By4BWKfkMMOWt9O9J1YiviO0tKE, self).__init__()
...
def go():
    try:
        model = Model_pff92By4BWKfkMMOWt9O9J1YiviO0tKE().to('cuda')
