...
class Model_RQwesEjgasLcAMdZ7EmpnbMHpRK3vmfx(nn.Module):
    def __init__(self):
        super(Model_RQwesEjgasLcAMdZ7EmpnbMHpRK3vmfx, self).__init__()
...
def go():
    try:
        model = Model_RQwesEjgasLcAMdZ7EmpnbMHpRK3vmfx()
...
def train(inp, label):
    model = Model_RQwesEjgasLcAMdZ7EmpnbMHpRK3vmfx().to('cpu')
    initialize(model)
